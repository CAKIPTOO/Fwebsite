...
var imagefeature = document.getElementsByClassName("onClick imagefeature");
 var previousimagefeature;
 for (var i=0; i<imagefeature.length; i++){
   imagefeature[i].onclick = function(){
 var classes = this.classList;
 if(classes.contains("show")){
	classes.remove("show");
 }
 else{
	if(previousimagefeature != null)
	previousimagefeature.classlist = this;
    classes.add("show");
 }
